...
{
	public class EmailContactService : INotificationService
	{
		public void Send(Notification notification)
		{
			//cast notification as EmailNorification
			//(EmailNotification)notification
			EmailContact email_notification = new EmailContact();
			email_notification = (EmailContact)notification;
